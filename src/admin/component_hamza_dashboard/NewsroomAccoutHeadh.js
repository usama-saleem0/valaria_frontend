...
const NewsroomAccountHeadh = ({ handleSearchChange, searchTerm, filterType, setFilterType, setVerificationFilter, verificationFilter, sortFilter, setSortFilter }) => {
        ...
        <div className="job--open--dash--news--h--filter--cont">
          ...
          <div className="job--open--dash--news--h--filter--main">
            ...
            <div className="job--open--dash--news--h--filter--drop--cont">
              ...
              {isStation && (
                <ul className="job--open--dash--news--h--filter--dropdown">
                  <li onClick={() => handleFilterSelect('Publications')}>Publications</li>
                  <li onClick={() => handleFilterSelect('Youtube')}>YouTube</li>
                  <li onClick={() => handleFilterSelect('Radio')}>Radio</li>
                  <li onClick={() => handleFilterSelect('Podcasts')}>Podcasts</li>
                  <li onClick={() => handleFilterSelect('')}>All Accounts</li>
            ...
            <div className="job--open--dash--news--h--filter--drop--cont">
              ...
              >
                <span>{verificationFilter || 'Verification'}</span> 
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="11"
                  height="7"
              ...
              {isProfession && (
                <ul className="job--open--dash--news--h--filter--dropdown">
                  <li onClick={() => handleVerificationSelect('Verified')}>Verified Accounts</li>
                  <li onClick={() => handleVerificationSelect('Not Verified')}>Not Verified</li>
                  <li onClick={() => handleVerificationSelect('')}>All Accounts</li>
                </ul>
              )}
            </div>
          </div>

          <div className="job--open--dash--news--h--filter--sort employee--dash--h--filter--sort">
...
export default NewsroomAccountHeadh;
