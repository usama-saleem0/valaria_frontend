...
const EmployeeAccountHeadh = ({ handleSearchChange, searchTerm, filterType, setFilterType, setVerificationFilter, verificationFilter, sortFilter, setSortFilter  }) => {
            ...
            <div className="job--open--dash--news--h--filter--drop--cont">
              ...
              {isStation && (
                <ul className="job--open--dash--news--h--filter--dropdown">
                  <li onClick={() => handleFilterSelect('Employee')}>Employee</li>
                  <li onClick={() => handleFilterSelect('Station')}>Station</li>
                </ul>
              )}
            </div>
...
export default EmployeeAccountHeadh;
