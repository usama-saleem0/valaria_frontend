  ...
  return (
    <div class="container">
      <div class="my--container--h  mx-auto">
        <div class="row">
          <div class="col">
            <div class="mb-4 d-flex justify-content-between align-items-center info--popup--head--cont">
              <div className="info--popup--title d-flex align-items-center">
                <div className="info--popup--img">
                  <img src={require("../../img/kabc.png")} alt="" />
                </div>
                <div className="info--popup--title--text">
                  ...
                  <div className="info--popup--title--text--h d-flex align-items-center">
                    <div className="info--popup--loc--img pe-1">
                      <svg
                      ...
                      >
                        <path
                          d="M0.673828 6.33364C0.673828 3.78477 2.09687 1.79572 4.27072 1.10443C7.4049 0.103537 10.67 1.88478 11.255 5.09526C11.5605 6.75775 11.1458 8.25484 10.0502 9.56533C8.87596 10.9691 7.67991 12.3602 6.49695 13.7597C6.17829 14.1372 5.84654 14.1372 5.52352 13.7597C4.30128 12.3178 3.06594 10.8843 1.86115 9.42537C1.0536 8.45417 0.686924 7.31757 0.673828 6.33364ZM6.00805 3.87807C4.84692 3.88232 3.91278 4.79838 3.91714 5.9265C3.92151 7.0419 4.86875 7.94525 6.02551 7.941C7.17355 7.93676 8.11642 7.01645 8.10769 5.90106C8.09896 4.78142 7.15609 3.87383 6.00805 3.87807Z"
                          fill="#828282"
                        />
                      </svg>
                    </div>
